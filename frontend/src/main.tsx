            ...
            <header className="tg-topbar">
                <div className="tg-topbar-inner">
                    ...
                    <div style={{ display: "flex", gap: 10 }}>
                        <Link to="/profile" className="tg-logout-btn" style={{ display: "inline-flex", alignItems: "center" }}>
                            Profile
                        </Link>
                        <Link to="/" className="th-logout-btn" style={{ display: "inline-flex", alignItems: "center" }}>
                            Main page
                        </Link>
                    </div>
